...
const TrustBar = () => {
  return (
    <section className="bg-[#0B3D6D] border-y border-white/10 py-5">
      <div className="container-site">
        <motion.div
          className="grid grid-cols-2 lg:flex lg:items-center lg:justify-center gap-4 lg:gap-0"
        ...
        >
          {signals.map((signal, i) => {
            ...
            return (
              <motion.div
                key={signal.label}
                className={`flex items-center gap-2.5 lg:px-6 lg:py-1 ${
